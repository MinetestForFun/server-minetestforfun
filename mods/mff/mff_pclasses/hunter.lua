...
pclasses.api.reserve_item("hunter", "throwing:spear_stone")
pclasses.api.reserve_item("hunter", "throwing:spear_steel")
pclasses.api.reserve_item("hunter", "throwing:spear_obsidian")
pclasses.api.reserve_item("hunter", "throwing:spear_diamond")
pclasses.api.reserve_item("hunter", "throwing:spear_mithril")
